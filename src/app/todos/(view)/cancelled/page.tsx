...
const Cancelled = () => {
  ...
  const { data, loading }: any = useFetch(`/todos/status/cancelled`, isRefresh);
  const {
    hasHigherRole,
    isAuthenticated,
    loading: authLoading,
      ...
      <div className="mb-6">
        <div className="flex items-center gap-3">
          <div className="w-9 h-9 bg-red-100 dark:bg-red-900/30 rounded-xl flex items-center justify-center">
            <i className="fa-solid fa-ban text-red-600 dark:text-red-400 text-sm"></i>
          </div>
          <div>
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center py-24 text-center">
          <div className="w-16 h-16 bg-red-50 dark:bg-red-900/20 rounded-full flex items-center justify-center mb-3">
            <i className="fa-solid fa-ban text-2xl text-red-300 dark:text-red-700"></i>
          </div>
